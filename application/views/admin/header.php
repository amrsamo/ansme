            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url() ?>admin/content"><i class="fa fa-pencil-square-o"></i> Website Content<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="<?= base_url() ?>admin/team">
                                <i class="fa fa-users"></i> Team Members<span class="fa arrow"></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/articles">
                                <i class="fa fa-pencil"></i> Articles<span class="fa arrow"></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/news">
                                <i class="fa fa-newspaper-o"></i> News<span class="fa arrow"></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/testimonials">
                                <i class="fa fa-users"></i> Testimonials<span class="fa arrow"></span>
                            </a>
                        </li>
                    </ul>
                </div>
